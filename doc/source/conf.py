...
html_theme_options = {
    "external_links": [],
    "github_url": "https://github.com/sahahn/BPt",
    "twitter_url": "https://twitter.com/SageHahn11",
}
...
# of the sidebar.
html_logo = '_static/red_logo.png'
...
def linkcode_resolve(domain, info):
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(BPt.__file__))

    return f"https://github.com/sahahn/BPt/blob/master/BPt/{fn}{linespec}"
...
def rstjinja(app, docname, source):
    ...
    src = source[0]
    rendered =\
        app.builder.templates.render_string(src,
